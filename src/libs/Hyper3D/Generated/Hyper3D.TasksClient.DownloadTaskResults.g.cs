...
namespace Hyper3D
{
    public partial class TasksClient
    {
        ...
        private static readonly global::Hyper3D.EndPointSecurityRequirement s_DownloadTaskResultsSecurityRequirement0 =
        ...
        private static readonly global::Hyper3D.EndPointSecurityRequirement[] s_DownloadTaskResultsSecurityRequirements =
            new global::Hyper3D.EndPointSecurityRequirement[]
            {                s_DownloadTaskResultsSecurityRequirement0,
            };
        partial void PrepareDownloadTaskResultsArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Hyper3D.DownloadRequest request);
        partial void PrepareDownloadTaskResultsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Hyper3D.DownloadRequest request);
        partial void ProcessDownloadTaskResultsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDownloadTaskResultsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Hyper3D.DownloadResponse> DownloadTaskResultsAsync(

            global::Hyper3D.DownloadRequest request,
            global::Hyper3D.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await DownloadTaskResultsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Hyper3D.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Hyper3D.AutoSDKHttpResponse<global::Hyper3D.DownloadResponse>> DownloadTaskResultsAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareDownloadTaskResultsArguments(
            ...
            var __authorizations = global::Hyper3D.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DownloadTaskResultsSecurityRequirements,
                operationName: "DownloadTaskResultsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDownloadTaskResultsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Hyper3D.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Hyper3D.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "DownloadTaskResultsAsync",
                                pathTemplate: "\"/api/v2/download\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDownloadTaskResultsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Hyper3D.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDownloadTaskResultsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Hyper3D.DownloadResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Hyper3D.AutoSDKHttpResponse<global::Hyper3D.DownloadResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Hyper3D.DownloadResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Hyper3D.DownloadResponse> DownloadTaskResultsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Hyper3D.DownloadRequest
            {
                TaskUuid = taskUuid,
            };

            return await DownloadTaskResultsAsync(
                request: __request,
                requestOptions: requestOptions,
