...
namespace Hyper3D
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Hyper3D.AutoSDKRetryOptions Retry { get; set; } = new global::Hyper3D.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Hyper3D.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Hyper3D.IAutoSDKHook>();
        ...
        public global::Hyper3D.AutoSDKClientOptions AddHook(
            global::Hyper3D.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Hyper3D.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Hyper3D.AutoSDKClientOptions UseAuthorizationProvider(
            global::Hyper3D.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Hyper3D.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Hyper3D.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Hyper3D.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Hyper3D.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Hyper3D.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Hyper3D.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Hyper3D.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Hyper3D.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Hyper3D.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Hyper3D.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Hyper3D.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Hyper3D.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Hyper3D.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Hyper3D.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Hyper3D.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Hyper3D.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Hyper3D.AutoSDKClientOptions clientOptions,
            global::Hyper3D.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Hyper3D.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Hyper3D.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Hyper3D.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Hyper3D.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Hyper3D.IAutoSDKHook, global::Hyper3D.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Hyper3D.AutoSDKHookContext context)
        {
