...
namespace Hyper3D
{
    public partial class AccountClient
    {
        ...
        private static readonly global::Hyper3D.EndPointSecurityRequirement s_CheckBalanceSecurityRequirement0 =
        ...
        private static readonly global::Hyper3D.EndPointSecurityRequirement[] s_CheckBalanceSecurityRequirements =
            new global::Hyper3D.EndPointSecurityRequirement[]
            {                s_CheckBalanceSecurityRequirement0,
            };
        partial void PrepareCheckBalanceArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareCheckBalanceRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessCheckBalanceResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCheckBalanceResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Hyper3D.BalanceResponse> CheckBalanceAsync(
            global::Hyper3D.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CheckBalanceAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Hyper3D.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Hyper3D.AutoSDKHttpResponse<global::Hyper3D.BalanceResponse>> CheckBalanceAsResponseAsync(
            global::Hyper3D.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCheckBalanceArguments(
                httpClient: HttpClient);


            var __authorizations = global::Hyper3D.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_CheckBalanceSecurityRequirements,
                operationName: "CheckBalanceAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Hyper3D.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Hyper3D.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CheckBalanceAsync",
                                pathTemplate: "\"/api/v2/check_balance\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Hyper3D.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCheckBalanceResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Hyper3D.BalanceResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Hyper3D.AutoSDKHttpResponse<global::Hyper3D.BalanceResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Hyper3D.BalanceResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
