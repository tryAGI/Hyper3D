...
The Hyper3D SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.

## Installation

```bash
dotnet add package Hyper3D
```
...
using var client = new Hyper3DClient(
    apiKey: Environment.GetEnvironmentVariable("HYPER3D_API_KEY")!);
